...
3. **Gestión eficiente de tickets**: Se realizará un análisis de una versión jugable a mediados de desarrollo de este hito y se aportarán _tickets_ para indicar posibles fallos o mejoras. Se evaluará la buena gestión de estos _tickets_ propuestos por el profesor.

### Indicaciones adicionales

1. **NO** uséis Makefiles para gestionar el proyecto, esto es algo que se realizará en las siguientes prácticas.
2. Si incluís alguna librería adicional, **haced constancia de ello en el documento asociado a la entrega** y documentad por qué se usa.
